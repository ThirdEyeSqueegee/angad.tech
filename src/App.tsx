        ...
        >
          ...
          >
            <Typography>
              ...
              focusing in system programming and data engineering. My interests
              include reverse engineering, game programming, neural networks and
              deep learning, computer vision, and artificial intelligence.
            </Typography>
            ...
            <motion.div animate={{ scale: [0, 1] }} transition={{ delay: 1 }}>
              <GitHubCalendar
                ...
                hideColorLegend
                blockSize={ratio > 4 / 3 ? 10 : 5}
                blockMargin={ratio > 4 / 3 ? 2 : 1}
                renderBlock={(b, a) => (
                  <Tooltip
                    title={`${a.count} contributions on ${a.date}`}
                    size="sm"
                  >
                    {b}
                  </Tooltip>
